...
const translations = {
  en: {
    ...
    'nav.holdingsAnalysis': 'Existing-holdings analysis',
  ...
  pt: {
    ...
    'nav.holdingsAnalysis': 'Análise das posições atuais',
  ...
  es: {
    ...
    'nav.holdingsAnalysis': 'Análisis de posiciones actuales',
  ...
  de: {
    ...
    'nav.holdingsAnalysis': 'Analyse bestehender Positionen',
